...
CREATE UNIQUE INDEX listing_images_one_cover_idx ON listing_images(listing_id) WHERE is_cover = TRUE;
...
CREATE INDEX accessories_public_order_idx ON accessories(published_at DESC, created_at DESC);
...
CREATE INDEX accessory_images_accessory_idx ON accessory_images(accessory_id);
CREATE INDEX accessory_images_order_idx ON accessory_images(accessory_id, sort_order);
CREATE UNIQUE INDEX accessory_images_one_cover_idx ON accessory_images(accessory_id) WHERE is_cover = TRUE;
